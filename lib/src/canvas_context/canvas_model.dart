...
class CanvasModel with ChangeNotifier {
  HashMap<String, ComponentFractal> components = HashMap();
  ...
  ComponentFractal getComponent(String id) {
    return components[id]!;
  }

  HashMap<String, ComponentFractal> getAllComponents() {
    return components;
  }
  ...
  /// Returns ComponentFractal id. useful when the id is set automatically.
