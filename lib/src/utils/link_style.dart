...
class LinkStyle {
  ...
  Path getLinePath(Offset point1, Offset point2, double scale,
      [Offset? point3]) {
    if (point3 != null) return getCoolLinePath(point1, point2, point3);
    switch (lineType) {
      case LineType.solid:
  ...
  Path getCoolLinePath(Offset point1, Offset point2, Offset point3) {
    Path path = new Path();
    path.moveTo(point3.dx, point3.dy);
