...
import '/src/canvas_context/model/diagram_data.dart';
...
class CanvasModelWriter extends ModelWriter
  ...
  /// Adds [ComponentFractal] to the canvas model.
  ///
  /// Returns component's id (if [ComponentFractal] doesn't contain id, new id if generated).
  /// Canvas is updated and this new components is shown on it.
  String addComponent(ComponentFractal c) {
    return _canvasModel.addComponent(c);
  }
  ...
  deserializeDiagram(
    ...
    for (final ComponentFractal in diagram.components) {
      _canvasModel.components[ComponentFractal.id] = ComponentFractal;
    }
